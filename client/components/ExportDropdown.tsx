...
export function ExportDropdown() {
  ...
  const { state, pklProjectName, analysisPlots, analysisWeatherStation, ecmMetrics, ecmPlots, utilityData } = useForm();
  ...
  async function handlePdf() {
    ...
    setStatus("pdf");
    try {
      await exportPdf({ state, pklProjectName, analysisPlots, analysisWeatherStation, ecmMetrics, ecmPlots, utilityData });
    } catch (e) {
